...
class TestProcessParquet(TestCase):
    ...
    def test_trimming_tuple_with_valid_time(self):
        ...
        self.assertIn("sample_1", result_trim["sample_id"].unique())
        self.assertIn("sample_3", result_trim["sample_id"].unique())
        self.assertNotIn("sample_2", result_trim["sample_id"].unique())