...
if __name__ == "__main__":
    ...
    #     prog="WC - Croptype Inference",
    #     description="Croptype inference using GFMAP, Presto and WorldCereal classifiers",
    # )
    ...
    minx, miny, maxx, maxy = (664000, 5611134, 684000, 5631134)
    epsg = 32631
    start_date = "2020-11-01"
    end_date = "2021-10-31"
    output_path = Path(
        "/vitodata/worldcereal/validation/internal_validation/inference_croptype_large.tif"
    )
