...
CROPCLASS_LIBRARY = "https://artifactory.vgt.vito.be:443/auxdata-public/hrlvlcc/openeo-dependencies/cropclass-1.0.4-20230630T184435.zip"  # NOQA
...
SENTINELHUB_JOB_OPTIONS = {"sentinel-hub": {"client-alias": "vito"}}
...
def get_job_options(provider: str = None, task: str = "inference"):
